...
export default function Comment_Section({ blog }) {
  ...
  var length = blog.comment.length
            ...
            <div>
              ...
              <ul>
                <li>
                  ...
                  <div onClick={loadMore} className={`items-center justify-end gap-2 text-base italic font-normal cursor-pointer font-interRegular md:text-lg text-skin-primary ${limit>=length ? 'hidden' : 'flex'}`}>
                    See More Comments
                    <span>
