        ...
        <div className='max-w-[901px] mx-auto'>
            <div className='flex md:flex-row flex-col gap-8 justify-between'>
                ...
                <div className='md:w-[32%] w-full steps'>
                    <button className='md:text-xl text-base font-extrabold font-interRegular text-skin-primary bg-white md:border border-[#2B195A] md:py-5 md:px-8 flex gap-3 items-center md:rounded-[5px]'>
