    ...
    return (
        <section className='py-20'>
            <div className='container mx-auto md:px-5 px-0'>
                <div className='max-w-[953px] mx-auto md:bg-[#F8F8F8] md:rounded-tr-md rounded-t-md md:p-16 p-5'>
                ...
                <div className='max-w-[953px] mx-auto md:bg-[#F8F8F8] md:rounded-br-md rounded-b-md md:p-16 p-5'>
