...
export default function Spromma() {
    return (
        <main>
            <section className={`md:pt-40 pt-32 pb-20 px-5 bg-[#F7F7F9] md:hidden block`}>
            ...
            <section className='md:pt-40 pt-32 pb-32 px-5 bg-[#F7F7F9] md:block hidden'>
                <div className='container mx-auto'>
            ...
            <section className='-mt-14 mb-16 md:block hidden'>
                <Statics />
            </section>
